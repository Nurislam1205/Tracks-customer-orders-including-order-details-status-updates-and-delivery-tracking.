...
public class OrderManager {
    ...
    public void createOrder(Scanner scanner, String username) {
        ...
        switch (choise) {
            case 1: deliveryType = DeliveryType.AVIA;
            break;
            case 2: deliveryType = DeliveryType.TRUCK;
            break;
            case 3: deliveryType = DeliveryType.TRAIN;
            break;
            default:
    ...
    public void updateOrder(Scanner in, String username) {
        ...
        orderToUpdate.setTotalPrice(orderToUpdate.getWeight() * orderToUpdate.getDeliveryType().getCostPerKg());saveOrdersToFile();
